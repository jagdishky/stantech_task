const colors = {
  THEME: 'rgba(0,86,179,1)',
  LIGHT_THEME_08: 'rgba(0,86,179,.8)',
  LIGHT_THEME_06: 'rgba(0,86,179, 0.6)',
  LIGHT_THEME_04: 'rgba(0,86,179, 0.4)',
  LIGHT_THEME_02: 'rgba(0,86,179, 0.2)',
  LIGHT_THEME_01: 'rgba(0,86,179, 0.1)',

  APP_BACKGROUND_WHITE: '#FFFF',
  APP_BACKGROUND: '#f5f5f5',
  APP_BLUE: '#DAE7F7',

  FLASH_NEWS_CARD_COLOR: '#0F192A',
  AUTH_BUTTON_COLOR: '#1D61E7',
  STATUS_RED_LIGHT: '#FEF2F2',
